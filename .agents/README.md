...
- `skills/` — Shared skills with `SKILL.md` frontmatter for agent autoloading, mirrored into `.claude/skills/`, `.codex/skills/`, and `.config/opencode/skills/` for per-tool discovery
