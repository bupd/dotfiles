...
alias clean="yes | pacrmorphans || true; yes | yaclr || true; sudo systemctl stop docker.socket || true; sudo systemctl stop docker || true; sudo rm -rf /var/lib/docker || true;"
